...
const Contact = () => {
  ...
  return (
    <>
    <span className=" invisible" id='Contant'/>
    <div className=' flex flex-col gap-4 py-4 lg:p-0 lg:gap-0 lg:h-[100vh] lg:flex-row'>
      <form onSubmit={handleSubmit(onSubmit)} className='w-[100%] lg:w-[50%] flex justify-center items-center'>
        <div className='w-[95%] lg:w-[80%] flex justify-center flex-col gap-3'>
          ...
          <Input label='名稱' id='name' register={register} errors={errors} disabled={isLoading} required/>
          <Input label='信箱' id='mail' register={register} errors={errors} disabled={isLoading} required/>
          <Input label='訊息' id='text' register={register} errors={errors} disabled={isLoading} required/>
